...
web_camouflage(){
    ...
    git clone https://github.com/seal0207/yqjk.git
    judge "web 站点伪装"
}
v2ray_install(){
...
update_sh(){
    ol_version=$(curl -L -s https://raw.githubusercontent.com/seal0207/V2Ray_ws-tls_bash_onekey/${github_branch}/install.sh | grep "shell_version=" | head -1 |awk -F '=|"' '{print $3}')
